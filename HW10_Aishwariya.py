...
class Student:
    ...
    def details(self):
        return [self.cwid,self.name,self.major,sorted(self.completed_courses.keys()),self.required,self.electives]
...
class Repository:
    ...
    def major_pt(self):
        ...
        for student in self.student.values():
            ...
            student.electives = self.majors[student.major].electives.difference(set(student.completed_courses.keys()))
